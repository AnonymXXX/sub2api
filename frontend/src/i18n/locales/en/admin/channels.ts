export default {
    ...
    subscriptions: {
      ...
      selectTargetPlan: 'Select a plan',
      expirationUnchanged: 'Expiration remains unchanged',
      switchCarryRule: 'The start date, quota windows, daily/weekly/monthly usage, and current temporary quota are carried over. Only API keys bound to the current subscription group are moved.',
      noSwitchTargets: 'No other active subscription plans are available on this platform',
      switchQuotaDaily: 'Daily ${value}',
      switchQuotaWeekly: 'Weekly ${value}',
      switchQuotaMonthly: 'Monthly ${value}',
      switchQuotaWarning: {
        title: 'These periods will fall back to balance immediately after switching',
        daily: 'Daily usage has reached the target plan limit',
        weekly: 'Weekly usage has reached the target plan limit',
        monthly: 'Monthly usage has reached the target plan limit, including temporary quota'
      },
      resetQuota: 'Reset Quota',
      resetQuotaTitle: 'Reset Usage Quota',
      resetQuotaFor: "Choose quota windows to reset for '{user}'.",
      resetDailyDesc: 'Reset only daily usage and restart the daily window now',
      resetWeeklyDesc: 'Reset only weekly usage and restart the weekly window now',
      resetMonthlyDesc: 'Reset only monthly usage and restart the monthly window now',
      monthlyResetWarning: 'Resetting monthly quota also clears this month’s temporary quota. Daily and weekly usage are unchanged.',
      selectResetPeriod: 'Select at least one window',
      quotaResetSuccess: 'Quota reset successfully',
      failedToResetQuota: 'Failed to reset quota',
      monthlyBonus: 'Temporary Quota',
      monthlyBonusTitle: 'Set Monthly Temporary Quota',
      monthlyBonusFor: "Set temporary quota for '{user}' in the current monthly window.",
      monthlyBonusAmount: 'Temporary quota total (USD)',
      monthlyBonusHint: 'This replaces the current monthly temporary quota; it is not an increment. Enter 0 to clear it. Existing usage, daily/weekly quotas, and expiry are unchanged.',
      monthlyBonusValue: 'Temporary +${bonus}, effective limit ${limit}',
      monthlyBonusSaved: 'Monthly temporary quota updated',
      invalidMonthlyBonus: 'Temporary quota must be a finite number greater than or equal to 0',
      failedToSetMonthlyBonus: 'Failed to set monthly temporary quota',
      ...
      subscriptionSwitched: 'Switched to {group}; moved {count} API key(s)',
      ...
      failedToSwitch: 'Failed to switch subscription',
      ...
      guide: {
        ...
        actions: {
          ...
          resetQuota: 'Reset Quota',
          resetQuotaDesc: 'Reset daily, weekly, or monthly usage independently',
          revoke: 'Revoke',
