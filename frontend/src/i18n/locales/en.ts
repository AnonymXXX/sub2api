export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      dataImportWarning: 'Import will create new accounts/proxies and apply the account capacity, priority, and group options below. Ensure existing data does not conflict.',
      dataImportFile: 'Data file',
      dataImportConcurrency: 'Account capacity',
      dataImportPriority: 'Priority',
      dataImportGroup: 'OpenAI group',
      dataImportNoGroup: 'No group binding',
