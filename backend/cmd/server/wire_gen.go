...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	routingAuditRepository := repository.NewRoutingAuditRepository(db)
	routingAuditService := service.NewRoutingAuditService(routingAuditRepository, accountRepository)
	routingAuditHandler := admin.NewRoutingAuditHandler(routingAuditService)
	...
	openAIGatewayHandler := handler.NewOpenAIGatewayHandler(openAIGatewayService, concurrencyService, billingCacheService, apiKeyService, usageRecordWorkerPool, routingAuditService, errorPassthroughService, contentModerationService, opsService, configConfig)
