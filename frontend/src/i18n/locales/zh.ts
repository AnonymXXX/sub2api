export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      syncFromAccountManager: '从 Account Manager 同步',
      dataExport: '导出',
      ...
      dataImportFile: '数据文件',
      dataImportJsonText: '粘贴 JSON',
      dataImportJsonTextPlaceholder: '{\n  "type": "sub2api-data",\n  "version": 1,\n  "proxies": [],\n  "accounts": []\n}',
      dataImportJsonTextHint: '可直接粘贴 Account Manager 导出的 Sub2API JSON；如果同时选择文件，将优先导入文件内容。',
      dataImportButton: '开始导入',
      dataImporting: '导入中...',
      dataImportSelectFile: '请选择数据文件',
      dataImportSelectSource: '请选择数据文件或粘贴 JSON',
      ...
      crsBack: '返回',
      syncFromAccountManagerTitle: '从 Account Manager 同步 API 凭证',
      syncFromAccountManagerDesc:
        '从 chatgpt-codex-account-manager 拉取 API 凭证导出的 Sub2API JSON 源，只同步 API 凭证转换出的账号。',
      accountManagerBaseUrl: 'Account Manager 服务地址',
      accountManagerBaseUrlPlaceholder: '例如：http://127.0.0.1:3000',
      accountManagerUsername: '用户名',
      accountManagerPassword: '密码',
      accountManagerExistingAccounts: '将按身份自动更新的已有账号',
      accountManagerNewAccounts: '新账号（可选择创建）',
      accountManagerNoNewAccounts: '所有 Account Manager API 凭证账号均已同步。',
      accountManagerWillUpdate: '将更新 {count} 个已有账号。',
      accountManagerSelectedCount: '已选择 {count} 个新账号',
      accountManagerUpdateBehaviorNote:
        '已有账号按 chatgpt_account_id、API Key 或邮箱等身份匹配后更新；普通本地 JSON 导入仍只创建新账号，不会覆盖。',
      accountManagerPreviewFailed: 'Account Manager 预览失败',
      editAccount: '编辑账号',
      deleteAccount: '删除账号',
