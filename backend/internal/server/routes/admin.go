...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.POST("/sync/account-manager", h.Admin.Account.SyncFromAccountManager)
		accounts.POST("/sync/account-manager/preview", h.Admin.Account.PreviewFromAccountManager)
