export default {
  ...
  subscriptionProgress: {
    ...
    weekly: '每周',
    monthly: '每月',
    baseMonthlyLimit: '基础额度',
    monthlyBonus: '临时额度',
    effectiveMonthlyLimit: '有效上限',
  ...
  payment: {
    ...
    subscribeNow: '立即开通',
    renewNow: '续费',
    renewalUnavailable: '月额度用完后可续费',
    activePlanLocked: '当前订阅生效中',
    renewalConfirmTitle: '续费将立即开始新周期',
    renewalConfirmDescription: '原剩余天数不保留，支付成功后重新计算 30 天；日、周、月用量和临时额度全部清零，并按当前价格收费。',
    selectPlan: '选择套餐',
    planFeatures: '功能特性',
    planCard: {
      rate: '倍率',
