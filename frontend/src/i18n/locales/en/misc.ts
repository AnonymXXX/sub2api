export default {
  ...
  subscriptionProgress: {
    ...
    weekly: 'Weekly',
    monthly: 'Monthly',
    baseMonthlyLimit: 'Base quota',
    monthlyBonus: 'Temporary quota',
    effectiveMonthlyLimit: 'Effective limit',
  ...
  payment: {
    ...
    renewNow: 'Renew',
    renewalUnavailable: 'Renew after monthly quota is exhausted',
    activePlanLocked: 'Current subscription is active',
    renewalConfirmTitle: 'Renewal starts a new cycle immediately',
    renewalConfirmDescription: 'Remaining days are not retained. After payment, a new 30-day cycle begins; daily, weekly, monthly usage and temporary quota are cleared, and the current price applies.',
