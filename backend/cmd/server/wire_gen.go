...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	subscriptionService := service.ProvideSubscriptionService(groupRepository, userSubscriptionRepository, apiKeyRepository, apiKeyAuthCacheInvalidator, billingCacheService, client, configConfig)
	...
	groupHandler := admin.NewGroupHandler(adminService, dashboardService, groupCapacityService, settingService)
