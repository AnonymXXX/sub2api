...
var (
	...
	PaymentOrdersColumns = []*schema.Column{
		...
		{Name: "subscription_action", Type: field.TypeString, Nullable: true, Size: 20},
	...
	PaymentOrdersTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "payment_orders_user_unfinished_subscription_unique",
				Unique:  true,
				Columns: []*schema.Column{PaymentOrdersColumns[41]},
				Annotation: &entsql.IndexAnnotation{
					Where: "order_type = 'subscription' AND status IN ('PENDING', 'PAID', 'RECHARGING')",
				},
			},
		},
	}
	...
	UserSubscriptionsColumns = []*schema.Column{
		...
		{Name: "weekly_usage_usd", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "monthly_usage_usd", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "monthly_bonus_usd", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
