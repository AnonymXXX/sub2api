export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      syncFromAccountManager: 'Sync from Account Manager',
      dataExport: 'Export',
      ...
      dataImportJsonText: 'Paste JSON',
      dataImportJsonTextPlaceholder: '{\n  "type": "sub2api-data",\n  "version": 1,\n  "proxies": [],\n  "accounts": []\n}',
      dataImportJsonTextHint: 'Paste Sub2API JSON exported from Account Manager directly. If a file is selected, the file content is imported first.',
      dataImportButton: 'Start Import',
      dataImporting: 'Importing...',
      dataImportSelectFile: 'Please select a data file',
      dataImportSelectSource: 'Please select a data file or paste JSON',
      ...
      crsBack: 'Back',
      syncFromAccountManagerTitle: 'Sync API Credentials from Account Manager',
      syncFromAccountManagerDesc:
        'Pull the Sub2API JSON source exported by chatgpt-codex-account-manager API Credentials. Only API credential-derived accounts are synced.',
      accountManagerBaseUrl: 'Account Manager Base URL',
      accountManagerBaseUrlPlaceholder: 'e.g. http://127.0.0.1:3000',
      accountManagerUsername: 'Username',
      accountManagerPassword: 'Password',
      accountManagerExistingAccounts: 'Existing accounts matched by identity',
      accountManagerNewAccounts: 'New accounts (select to create)',
      accountManagerNoNewAccounts: 'All Account Manager API credential accounts are already synced.',
      accountManagerWillUpdate: 'Will update {count} existing accounts.',
      accountManagerSelectedCount: '{count} new accounts selected',
      accountManagerUpdateBehaviorNote:
        'Existing accounts are updated by chatgpt_account_id, API key, email, or other stable identity. Regular local JSON import still creates only and will not overwrite accounts.',
      accountManagerPreviewFailed: 'Account Manager preview failed',
