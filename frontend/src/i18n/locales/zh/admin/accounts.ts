export default {
    accounts: {
      ...
      dataImportWarning: '导入将创建新账号与代理，并按下方选项设置账号容量、优先级和分组；请确认已有数据不会冲突。',
      dataImportFile: '数据文件',
      dataImportConcurrency: '账号容量',
      dataImportPriority: '优先级',
      dataImportGroup: 'OpenAI 分组',
      dataImportNoGroup: '不绑定分组',
